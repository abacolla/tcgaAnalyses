...
Script 2 -- vga_survivalCurve.sh - make survival curve for patients with high (above mean) versus low (below mean) gene expression

Synopsis: vga_survivalCurve.sh <TCGA_TUMOR> <GENE_NAME> - where TCGA_TUMOR is the TCGA tumor code and GENE_NAME an official gene name, both in capital letters
